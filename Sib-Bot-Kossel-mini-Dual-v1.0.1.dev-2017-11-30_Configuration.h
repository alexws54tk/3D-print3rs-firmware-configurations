/*
    Sib Bot Kossel mini Dual v1.0.1.dev-2017-11-30 
...
#define EXT0_PID_PGAIN_OR_DEAD_TIME 17
#define EXT0_PID_I 2
...
#define EXT1_PID_PGAIN_OR_DEAD_TIME 17
#define EXT1_PID_I 2
#define EXT1_PID_D 43
...
#define RETRACTION_LENGTH 80
#define RETRACTION_LONG_LENGTH 100
#define RETRACTION_SPEED 120
#define RETRACTION_Z_LIFT 10
#define RETRACTION_UNDO_EXTRA_LENGTH 90
#define RETRACTION_UNDO_EXTRA_LONG_LENGTH 90
#define RETRACTION_UNDO_SPEED 20
#define FILAMENTCHANGE_X_POS 0
#define FILAMENTCHANGE_Y_POS 0
#define FILAMENTCHANGE_Z_ADD  10
#define FILAMENTCHANGE_REHOME 2
#define FILAMENTCHANGE_SHORTRETRACT 80
...
#define DELTA_SEGMENTS_PER_SECOND_MOVE 72 // Less accurate setting for other moves
...
#define ZHOME_X_POS 999
#define ZHOME_Y_POS 999
...
#define UI_PRINTER_NAME "Kossel One"
#define UI_PRINTER_COMPANY "SibBot"
...
#define UI_SET_MIN_EXTRUDER_TEMP   20
...
========== Start configuration string ==========
{
    ...
    "yEndstopBack": 1,
    "zEndstopBack": 0,
    "deltaSegmentsPerSecondPrint": 160,
    "deltaSegmentsPerSecondTravel": 72,
    "deltaDiagonalRod": 218,
    "deltaHorizontalRadius": 100,
    "deltaAlphaA": 210,
    "deltaAlphaB": 330,
    "deltaAlphaC": 90,
    ...
    "hasHeatedBed": "1",
    "enableZProbing": "0",
    "extrudeMaxLength": 510,
    "homeOrder": "HOME_ORDER_ZXY",
    "featureController": 2,
    "uiPrinterName": "Kossel One",
    "uiPrinterCompany": "SibBot",
    ...
    "retractionLength": 80,
    "retractionLongLength": 100,
    "retractionSpeed": 120,
    "retractionZLift": 10,
    "retractionUndoExtraLength": 90,
    "retractionUndoExtraLongLength": 90,
    "retractionUndoSpeed": 20,
    "filamentChangeXPos": 0,
    "filamentChangeYPos": 0,
    "filamentChangeZAdd": 10,
    "filamentChangeRehome": 2,
    "filamentChangeShortRetract": 80,
    "filamentChangeLongRetract": 500,
    "fanKickstart": 200,
    "servo0StartPos": -1,
    "servo1StartPos": -1,
    "servo2StartPos": -1,
